...
namespace XFlag.Alter3Simulator
{
    ...
    {
        void Visit(CalibCommand command);
    }

    public partial interface ICommandVisitor<T>
    {
        T Visit(CalibCommand command);
    }

    public partial class CommandVisitorBase : ICommandVisitor
    {
        public virtual void Visit(CalibCommand command) => Default(command);
    }

    public partial class CommandVisitorBase<T> : ICommandVisitor<T>
    {
        public virtual T Visit(CalibCommand command) => Default(command);
    }
}
