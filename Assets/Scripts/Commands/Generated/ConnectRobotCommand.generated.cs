...
namespace XFlag.Alter3Simulator
{
    ...
    {
        protected internal virtual void Visit(ConnectRobotCommand command) => Default(command);
    }

    public partial class CommandVisitorBase<T>
    {
        protected internal virtual T Visit(ConnectRobotCommand command) => Default(command);
    }
}
