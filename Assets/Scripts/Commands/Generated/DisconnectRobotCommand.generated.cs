...
namespace XFlag.Alter3Simulator
{
    ...
    {
        public virtual void Visit(DisconnectRobotCommand command) => Visit((ICommand)command);
    }

    public partial class CommandVisitorBase<T>
    {
        public virtual T Visit(DisconnectRobotCommand command) => Visit((ICommand)command);
    }
}
